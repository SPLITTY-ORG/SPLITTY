  ...
  return (
    <div className="space-y-6">
      ...
      <div className="panel">
        ...
        {arcSwitch.isMismatched && (
          <div className="mt-2 flex items-center justify-between bg-[#C4553D]/10 border border-[#C4553D]/30 rounded p-2">
            <span className="text-[#C4553D] text-sm">Switch to Arc to split</span>
            <button
