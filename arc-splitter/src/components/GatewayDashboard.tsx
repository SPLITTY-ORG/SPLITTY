      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-[#241B14] border border-[rgba(242,177,52,0.16)] rounded p-4">
          ...
          {depositSwitch.isMismatched && (
            <div className="bg-[#C4553D]/10 border border-[#C4553D]/30 rounded p-2 mb-3 flex items-center justify-between">
              <span className="text-[#C4553D] text-sm">Switch to {depositSwitch.targetChain.label} to continue.</span>
              <button
        ...
        <div className="bg-[#241B14] border border-[rgba(242,177,52,0.16)] rounded p-4">
          ...
          {bridgeSwitch.isMismatched && (
            <div className="bg-[#C4553D]/10 border border-[#C4553D]/30 rounded p-2 mb-3 flex items-center justify-between">
              <span className="text-[#C4553D] text-sm">Switch to {bridgeSwitch.targetChain.label} to continue.</span>
              <button
